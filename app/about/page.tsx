        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-6 flex justify-center">
            <div className="w-full max-w-md relative p-8 rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 border border-slate-800 shadow-2xl backdrop-blur-xl">
              ...
              <h3 className="text-xl font-bold text-white mb-1">Sabinus Okpara</h3>
              <p className="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-6">Unit Manager</p>
              ...
              <div className="space-y-4 text-sm border-t border-b border-slate-800/80 py-6 my-6">
                ...
                <div className="flex items-center justify-between text-slate-300">
                  ...
                  <div className="text-right">
                    <a href={`tel:${siteConfig.contact.phone}`} className="block font-semibold text-blue-400 hover:underline">
                      {siteConfig.contact.phone}
                    </a>
                    <a href={`tel:${siteConfig.contact.phone2}`} className="block font-semibold text-blue-400 hover:underline">
