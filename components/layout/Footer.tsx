        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a href={siteConfig.social.facebook} className="text-slate-400 hover:text-white" target="_blank" rel="noreferrer">
                <span className="sr-only">Facebook</span>
                <Facebook className="h-6 w-6" />
              </a>
              <a href={siteConfig.social.instagram} className="text-slate-400 hover:text-white" target="_blank" rel="noreferrer">
                <span className="sr-only">Instagram</span>
                <Instagram className="h-6 w-6" />
              </a>
              <a href={siteConfig.social.linkedin} className="text-slate-400 hover:text-white" target="_blank" rel="noreferrer">
