...
export default function Globe({
    ...
    const markersStr = JSON.stringify(markerConfig.markers);
    ...
    useEffect(() => {
        ...
        const loadWorldData = async () => {
            try {
                ...
                let landFeatures;
                if (cachedLandData) {
                    landFeatures = cachedLandData;
                } else {
                    if (!activeFetchPromise) {
                        activeFetchPromise = fetch(
                    ...
                    landFeatures = await activeFetchPromise;
                    cachedLandData = landFeatures;
                }
